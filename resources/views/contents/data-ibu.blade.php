<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input value="{{ $student->nama_ibu }}" type="text" name="nama" id="nama" style="text-transform:uppercase"
  ...
  <div class="form-group">
    ...
    <input value="{{  $student->tgl_lahir_ibu}}" type="text" name="tgl_lahir" id="tgl_lahir"
  ...
  <div class="from-group">
    <div class="row">
      <div class="col-sm-8">
        ...
        <!-- <small class="form-text text-muted">Isi nama Sesuai Akta Kelahiran</small> -->
        <input value="{{$student->alamat_ibu}}" type="text" name="alamat" id="alamat"
          class="form-control @error ('alamat') is-invalid @enderror">
        @error ('alamat') <div class="invalid-feedback">{{ $message }}</div> @enderror
      </div>
      <div class="col">
        <label for="rt">RT:</label>
        <input value="{{ $student->rt_ibu }} " maxlength="4" type="text" name="rt" id="rt"
          class="form-control @error ('rt') is-invalid @enderror">
        @error ('rt') <div class="invalid-feedback">{{ $message }}</div> @enderror
      </div>
      <div class="col">
        <label for="rw">RW:</label>
        <input value="{{ $student->rw_ibu }}" maxlength="4" type="text" name="rw" id="rw"
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <!-- <small class="form-text text-muted">Isi nama Sesuai Akta Kelahiran</small> -->
        <input value="{{$student->desa_ibu}}" type="text" name="desa" id="desa"
          class="form-control @error ('desa') is-invalid @enderror">
        @error ('desa') <div class="invalid-feedback">{{ $message }}</div> @enderror
      </div>
      <div class="col-sm-6">
        <label for="kecamatan">Kecamatan:</label>
        <input value="{{$student->kec_ibu}}" type="text" name="kec" id="kecamatan"
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <input value="{{$student->kab_ibu}}" type="text" name="kab" id="kabupaten"
        class="form-control @error ('kabupaten') is-invalid @enderror">
      @error ('kabupaten') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
    <div class="col-sm-6">
      <label for="provinsi">Provinsi:</label>
      <input value="{{ $student->prov_ibu}}" type="text" name="prov" id="provinsi"
