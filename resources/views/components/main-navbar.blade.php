  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        $countNotifications = sizeof(auth()->user()->unreadNotifications);
        @endphp
          ...
          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
              ...
              <div>
                ...
                <span class="font-weight-bold">{{ $notif['data']['amount'] }}</span>
              </div>
            </a>
            @endforeach
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
            ...
            <img width=30 style="border:1px solid" class="img-profile rounded-circle"
              src="{{  asset(Auth::user()->userable->biodata->foto) }}">
...
{{-- @if (auth()->user()->is_admin)
  <script>
    function sendMarkRequest(id=null){
      return $.ajax({
        type: "method",
        url: "{{ route('route('admin.marknotification') }}",
data: {
_token,
id
},
...
$(function(){
$('.mark-as-read').click(){
let request = sendMarkRequest($(this).data());
request.done(()=>)
}
})
</script>
